...
def main():
    X_train = pd.read_csv('X_train-ecfp6.csv')
    X_test = pd.read_csv('X_test-ecfp6.csv')
    y_train = pd.read_csv('y_train-ecfp6.csv')
    y_test = pd.read_csv('y_test-ecfp6.csv')
    y_scaler = 'y_scaler-ecfp6.pkl'
