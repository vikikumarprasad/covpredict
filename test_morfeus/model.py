...
def main():
    X_train = pd.read_csv('X_train-morfeus.csv')
    X_test = pd.read_csv('X_test-morfeus.csv')
    y_train = pd.read_csv('y_train-morfeus.csv')
    y_test = pd.read_csv('y_test-morfeus.csv')
