...
def main():
    X_train = pd.read_csv('X_train-mordred2.csv')
    X_test = pd.read_csv('X_test-mordred2.csv')
    y_train = pd.read_csv('y_train-mordred2.csv')
    y_test = pd.read_csv('y_test-mordred2.csv')
